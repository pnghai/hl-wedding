  ...
  return(
    <section id="organization" className="bg-hint-of-red py-24">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 bg-cover bg-no-repeat border border-[#F6F1F0] divide-x divide-y divide-[#F6F1F0] bg-center" style={{ backgroundImage: `url(${slider})`, }}>
