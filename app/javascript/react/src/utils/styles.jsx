...
const Aside = tw.aside`float-left w-0 md:w-[30%] xl:w-[22%] h-screen md:py-16 md:px-8 overflow-y-scroll bg-[#f6f1f0] flex-col flex align-items-center text-center`;
...
const Main = tw.div`h-screen float-right duration-500 transition-all ease-in-out w-full md:w-[70%] xl:w-[78%] overflow-scroll`;
