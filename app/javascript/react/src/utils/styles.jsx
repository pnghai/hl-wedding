...
const Aside = tw.aside`fixed top-0 left-0 md:translate-x-0 md:block float-left w-[270px] md:w-[30%] xl:w-[22%] h-screen px-2 py-12 md:px-8 md:py-16 overflow-y-scroll bg-[#f6f1f0] flex-col flex align-items-center text-center transition-all duration-500`;
